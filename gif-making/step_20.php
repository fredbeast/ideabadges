...
<main>
    <section id="ps_gifs_activity">
        ...
        <div class="badgeDescriptionBoxTwo"><p class="center-align">Drag and drop these boxes into their correct
                containers. The next five steps are about using <strong>the Timeline</strong> and <strong>adjusting the
                    visibility of frames</strong> to create an animation.</p></div>
        <br>
        <div class="container">
        ...
        <div class="container">
            <div id="droppableContainer">
                <div class="row"></div>
                <div class="row">
                    <div class="col s12 l6"><p id="pNumber">D</p>
                        <div id="droppablePsStep4"></div>
                    </div>
                    <div class="col s12 l6"><p id="pNumber">E</p>
                        <div id="droppablePsStep5"></div>
                    </div>
                </div>
                <div class="row">
                    <div class="col s12 l6"><p id="pNumber">F</p>
                        <div id="droppablePsStep6"></div>
                    </div>
                    <div class="col s12 l6"><p id="pNumber">G</p>
                        <div id="droppablePsStep7"></div>
                    </div>
                </div>
                <div class="row">
                    <div class="col s12 l12"><p id="pNumber">H</p>
                        <div id="droppablePsStep8"></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col s1 l1">
                    <img class="imgSuccess" style=" width:100%; display: none;"
                         src="public/images/gifs/Gif_Character_Introduction_290.gif"/>
                </div>
                <div class="col s1 l1">
                    <img class="imgSuccess" style=" width:100%; display: none;" src="public/images/birth-confetti.gif"/>
                </div>
        ...
        <div class="row">
            <div class="col s12">
                <a id="step21Button" style="display:none;"
                   class='btn-floating btn-large waves-effect waves-yellow buttonCentre animated infinite pulse'
                   href='step_21.php'><i class='material-icons'>trending_flat</i></a>
            </div>
        </div>
    </section>
</main>
