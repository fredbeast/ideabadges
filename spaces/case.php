...
.background {
	...
	background-image: url(imgs/2d3dcad/startttaskbackgrounds/January.png); 
...
@media only screen and (min-width: 993px) and (max-width : 1038px) {

.background {
	
	background-image: url(imgs/2d3dcad/startttaskbackgrounds/Januarysparks.png); 
	background-repeat: repeat; 
	background-size: 5000px, contain;
	background-position: center left -2020px;
...
.background {
	...
	background-repeat: repeat; 
	background-size: 5000px, contain;
	background-position: center left -2140px;
	background-attachment: scroll !important;
...
<body style="background-color: rgb(0, 1, 17)">
...
<div id="summary" class="container-fluid text-center animated fadeIn"><img src="imgs/task0/jan.png" width="50px" style="margin:10px; margin-top: -20px"/><br>
    <h4 class="text-center whitebbgr hvr-wobble-bottom" style="margin-top: 25px !important; margin-bottom: 27px !important; padding-left: 20px; padding-right: 20px; max-width: 571px">New Year has just passed. After receiving a brand new phone for Christmas which you <br> love and treasure dearly… you drop it! 
<br><br>Luckily, your screen did not crack but in case you are not so lucky next time, you want to make a phone case to protect it.<br><br>
Which software would be the best to use for designing your phone case?</h4> 
     ...
     <div class="row">
     <div class="col-md-4">
     <img src="imgs/case/case1.jpg" class="text-center img-rounded img-thumbnail" style="margin:5px; margin-bottom: 40px; margin-top:2px" width="278px" alt="2D Design">
     
     </div>
     <div class="col-md-4">
     <img src="imgs/case/case2.jpg" class="text-center img-rounded img-thumbnail" style="margin:5px; margin-right:-2px; margin-top: 4px; margin-bottom: 40px" width="280px" alt="3D Design">
     
     </div>
     <div class="col-md-4">
     <img src="imgs/case/case3.jpg" class="text-center img-rounded img-thumbnail" style="margin:5px" width="280px" alt="2D Design">
...
<br>
   ...
   <div id="alertsuccess" class="alert alert-success alert-dismissable animated fadeIn fade in text-center" role="alert" style="display: none">
    <strong>Correct!</strong> This item is a solid object that requires lots of 3D shaping. It will require shaping on both the inside and outside to create the details when looking at the object from different angles and those in its multiple planes. 
  </div>
  <div id="alertdanger" class="alert alert-danger alert-dismissable animated fadeIn fade in text-center" role="alert" style="display: none">
    <p> <strong>Incorrect!</strong> This item is a solid object that will require lots of 3D shaping. It will require shaping on both the inside and outside to create the details when looking at the object from different angles. <br><br> <a href="case.php" <button class="close" style="float: none; font-size: medium; position: inherit"> Reset </button> </a> </p>
  </div>
  </div>
...
<div id="next" class="container-fluid text-center animated fadeIn" hidden>
    ...
    <div class="row">
    <div class="col-sm-8 col-sm-offset-2"><a href="jewel.php">
...
<div class="container-fluid text-center animated fadeInDown">
   ...
   <div class="progress-bar progress-bar-info progress-bar-striped active hvr-grow" role="progressbar" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100" style="width: 15%"> Progress&nbsp;15% 
  </div>
  
  </div>
  
 
<div class="container-fluid" style="background: rgba(0,0,0,0.32)">
  <div class="row">
...
$(function() {
  ...
  $('.progress-bar').animate({ 
	...
	$('.progress-bar').delay(1000).html('Progress&nbsp;20%');
	});
