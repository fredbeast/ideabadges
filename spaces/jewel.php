...
.background {
	...
	background-image: url(imgs/2d3dcad/startttaskbackgrounds/February.png); 
...
<body style="background-color: rgb(108, 20, 42)">
...
<div id="summary" class="container-fluid text-center animated fadeIn"><img src="imgs/task0/feb.png" width="50px" style="margin:10px; margin-top: -20px"/><br>
    <h4 class="text-center transbbgr hvr-wobble-bottom" style="margin-top: 25px !important; margin-bottom: 27px !important; padding-left: 20px; padding-right: 20px; max-width: 571px">Valentine's day is near & you want to make an item of jewellery for someone that is special to you. You've decided to make a simple, flat pendant or some simple, flat designed earrings.<br><br>
Which software would be the best to use for designing your jewellery?</h4> 
     ...
     <div class="row">
     <div class="col-md-4">
     <img src="imgs/jewel/jewel1.jpg" class="text-center img-rounded img-thumbnail" style="margin:5px; margin-bottom: 40px; margin-top:5px; margin-top: -20px" width="300px" alt="2D Design">
     
     </div>
     <div class="col-md-4">
     <img src="imgs/jewel/jewel2.png" class="text-center img-rounded img-thumbnail" style="margin:5px; margin-right:-8px; margin-top: 4px; margin-bottom: 40px" width="235px" alt="3D Design">
     
     </div>
     <div class="col-md-4">
     <img src="imgs/jewel/jewel3.jpg" class="text-center img-rounded img-thumbnail" style="margin:5px; margin-top:6px" width="275px" alt="2D Design">
...
<div class="container-fluid text-center animated fadeInDown">
 ...
 <div class="progress-bar progress-bar-info progress-bar-striped active hvr-grow" role="progressbar" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100" style="width: 20%"> Progress&nbsp;20% 
  </div>
  
  </div>
  
 
<div class="container-fluid" style="background: rgba(0, 0, 0, 0.82)">
  <div class="row">
...
$(function() {
 ...
 $('.progress-bar').animate({ 
	...
	$('.progress-bar').delay(1000).html('Progress&nbsp;25%');
	});
